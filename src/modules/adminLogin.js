...
class AdminLogin extends React.Component {
    ...
    handleSubmit(e) {
        ...
        fetch("https://0.0.0.0:8000/login", {
            ...
            body: searchParams,
            headers: headers
        }).then(result => { if (result.ok) { return result.json(); } throw new Error('Network response was not ok.'); })
            .then(user => { console.log('User logged in', user); browserHistory.push('/adminDashboard'); })
